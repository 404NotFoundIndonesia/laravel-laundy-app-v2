...
const form = useForm({
    name: page.props.supplier.name,
    contact_person: page.props.supplier.contact_person,
    email: page.props.supplier.email,
    phone: page.props.supplier.phone,
    address: page.props.supplier.address,
});

const submit = () => {
    form.put(route('supplier.update', page.props.supplier.id), {
        preserveScroll: true,
        preserveState: true,
    });
};
        ...
        <template #header>
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <Link :href="route('supplier.show', $page.props.supplier.id)">
                            <h2 class="font-semibold text-xl text-gray-400 hover:text-gray-600 leading-tight">
